...
import com.mkwinformatica.cursomc.domain.PagamentoComCartao;
import com.mkwinformatica.cursomc.domain.Pedido;
import com.mkwinformatica.cursomc.domain.Produto;
...
import com.mkwinformatica.cursomc.repositories.CidadeRepository;
...
import com.mkwinformatica.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "marcoskwerle@gmail.com", "3678912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2004", null, "Centro", "74266424", cli2, c2);
		...
		cli2.getTelefones().addAll(Arrays.asList("35742468", "35784257"));
